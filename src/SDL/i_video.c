...
void I_UpdateVideoMode(void)
{
  ...
  else
  {
...
#ifdef __ANDROID__ //Android this screen mode. Can also fix the pallet above if this is slow..
    buffer = SDL_CreateRGBSurface(0, REAL_SCREENWIDTH, REAL_SCREENHEIGHT, 32, 0xff << 0, 0xff << 8, 0xff << 16, 0xff << 24 );
#else
    ...
    {
#ifdef __ANDROID__
      sdl_texture_upscaled = SDL_CreateTexture(sdl_renderer, SDL_PIXELFORMAT_RGBA8888,
